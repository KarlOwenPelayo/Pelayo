...
public class PemdasCalculator {
   ...
   public double evaluate(String expression) {
      ...
      // Handle negative numbers and small numbers in scientific notation
      expression = expression.replace("(-", "(0-");
      expression = expression.replace("e-", "e0-");
   ...
   public static void main(String[] args) {
      ...
      PemdasCalculator calc = new PemdasCalculator();
